...
//					                In such case, the file name created includes extra ".txt", for example: "ºÓ³Õ2501-3000 citation.txt.paj"
...
//============
		...
		// adjust PN network for serial documents, added 2017/05/30, added WOS_DATA 2018/01/31, added TIP_DATA, 2018/05/08
	{
		...
		fwprintf(logstream, L"Number of serial documents (paper family/¾ú¼f®×¥ó/patent family) combined = %d\n\n", ncombine);
	}
